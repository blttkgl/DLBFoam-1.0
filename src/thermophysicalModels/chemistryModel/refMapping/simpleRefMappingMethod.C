...
bool simpleRefMappingMethod::check_if_refcell(const chemistryProblem& problem) const{
...
bool simpleRefMappingMethod::shouldMap(const chemistryProblem& problem) const{ return check_if_refcell(problem); }
